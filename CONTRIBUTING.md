...
issue](https://github.com/cisagov/ansible-role-remove-python2/issues) in
...
request](https://github.com/cisagov/ansible-role-remove-python2/pulls), you
...
```console
cd ansible-role-remove-python2
pyenv virtualenv <python_version_to_use> ansible-role-remove-python2
pyenv local ansible-role-remove-python2
